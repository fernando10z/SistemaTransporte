            ...
            echo "<tr>
                    ...
                    <td>
                        <button class='btn btn-sm btn-success' 
                                onclick='editarSeleccionarClienteNatural({$cliente['idCliente']}, \"".htmlspecialchars($cliente['nombre'], ENT_QUOTES)."\", \"".htmlspecialchars($cliente['apellidopat'], ENT_QUOTES)."\", \"".htmlspecialchars($cliente['apellidoMat'], ENT_QUOTES)."\")'>
                            Seleccionar
                        </button>
                    </td>
                  </tr>";
