...
<div class="container-fluid">
  <div class="page-inner">
    <div class="page-header">
      <div>
        <h3 class="page-title">Gestión de Servicios</h3>
        ...
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex">
              ...
              <div class="btn-group ml-2">
                <button class="btn btn-primary" onclick="abrirModalServicios()">
          ...
          <div class="filtros-avanzados" id="filtrosAvanzados">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <label for="filtroTipo">Tipo de Carga</label>
                  <div class="select-container">
                    <select class="form-control" id="filtroTipo">
                      <option value="">Todos</option>
                      <?php
                      // Obtener tipos de carga únicos de la base de datos
                      $sqlTipos = "SELECT DISTINCT tipoCarga FROM servicios WHERE tipoCarga IS NOT NULL AND tipoCarga != ''";
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="filtro-input">
                    ...
                    <input type="text" class="form-control" id="filtroBusquedaGlobal" placeholder="Buscar por nombre, descripción...">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card-body">
            <div class="table-responsive table-fade-in">
              <table id="servicios-table" class="display table table-hover w-100">
                <thead>
                  <tr>
                    <th width="70px">ID</th>
                    <th>Nombre</th>
                ...
                <tbody>
                  ...
                  foreach ($servicios as $row) {
                      echo "<tr>";
                      echo "<td><span class='id-servicio'>{$row['id']}</span></td>";
                      ...
                      echo "<button class='btn btn-primary btn-icon btn-sm editar-servicio' 
                              data-id='{$row['id']}'
                              title='Editar servicio'>
                              <i class='fas fa-pen'></i>
                            </button>";

                      echo "<button class='btn btn-danger btn-icon btn-sm eliminar-servicio'
                              data-id='{$row['id']}'
                              title='Eliminar servicio'>
                              <i class='fas fa-trash'></i>
                            </button>";

                      echo "<button class='btn btn-warning btn-icon btn-sm cambiar-estado-servicio'
                              data-id='{$row['id']}'
...
<form id="pdfForm" action="reportes/generarpdfservicios.php" method="post" style="display: none;">
  ...
  <?php include('servicio/modal.php')?>
  <?php include('servicio/modaleditar.php')?>
  
  <script>
    function abrirModalServicios() {
        if (typeof $('#registrarServicioModal').modal !== 'function') {
        ...
        const registrarServicioForm = document.getElementById('registrarServicioForm');
        if (registrarServicioForm) {
          registrarServicioForm.reset();
        } else {
            console.warn('Formulario con ID "registrarServicioForm" no encontrado');
        }
    }
...
$(document).ready(function() {
  ...
  var table = $('#servicios-table').DataTable({
    ...
    language: {
      ...
      emptyTable: '<div class="text-center my-5"><i class="fas fa-tools fa-3x text-muted mb-3"></i><p class="text-muted">No hay servicios registrados</p></div>'
    },
    pageLength: 10,
