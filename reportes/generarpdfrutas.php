            ...
            <table width="100%" cellpadding="0" cellspacing="10">
                <tr>
                    <td width="33%" align="center" style="background-color: #e9ecef; padding: 10px; border-radius: 5px;">
                        <div style="font-size: 11px; color: #555; margin-bottom: 5px;">Total Rutas</div>
                        <div style="font-size: 14px;">' . $totalRutas . '</div>
                    </td>

                    <td width="33%" align="center" style="background-color: #e9ecef; padding: 10px; border-radius: 5px;">
                        <div style="font-size: 11px; color: #555; margin-bottom: 5px;">Rutas Activas</div>
                        <div style="font-size: 14px;">' . $rutasActivas . '</div>
                    </td>

                    <td width="33%" align="center" style="background-color: #e9ecef; padding: 10px; border-radius: 5px;">
                        <div style="font-size: 11px; color: #555; margin-bottom: 5px;">Rutas Inactivas</div>
                        <div style="font-size: 14px;">' . $rutasInactivas . '</div>
                    </td>
                </tr>
            </table>
        </td>
