...
foreach ($categorias as $categoria) {
    ...
    // ID
    $html .= '<td>' . strip_tags($categoria[0]) . '</td>';
    
    // Almacén
    $html .= '<td>' . strip_tags($categoria[1]) . '</td>';
    
    // Categoría
    $html .= '<td>' . strip_tags($categoria[2]) . '</td>';
    
    // Descripción
    $html .= '<td>' . strip_tags($categoria[3]) . '</td>';
    
    // Fecha Registro
    $html .= '<td>' . strip_tags($categoria[4]) . '</td>';
